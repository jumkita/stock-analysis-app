    ...
    try:
        ...
        for model_id in model_ids:
            try:
                ...
                return {"rank": rank, "conclusion": conclusion or text[:50], "verdict": verdict}
            except Exception as e:
                err_str = str(e)
